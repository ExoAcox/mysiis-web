...
describe("odp-summary", async () => {
  test("should odp-summary mobile version", async () => {

    vi.useFakeTimers();
    render(<OdpSummaryPage user={user} device={"mobile"} />);
    ...
    const btnFilter = screen.getByTestId('button-test')
