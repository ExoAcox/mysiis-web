...
describe("Point with data exchange", () => {
    test("Point with data exchange snapshot", async () => {
    ...
    test("Point with data exchange to trigger modalPointRedeemAddressConfirmation", async () => {
        getPointDescription();
        getTaskNotHaveData();
        getMyWallet();
        getVoucher();
