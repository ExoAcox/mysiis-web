...
const AddressSuccessModal = (): JSX.Element => {
    const { modal, setModal } = useModal("modal-profile-address-success");
        ...
        <Modal visible={modal} className="w-fit p-6 rounded-xl">
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <p className="text-black-100">Terima kasih telah melengkapi data alamat Anda</p>
                    <Button
                        type="submit"
