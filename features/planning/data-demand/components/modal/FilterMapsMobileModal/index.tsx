...
const FilterMapsMobileModal = ({ access }: Props): JSX.Element => {
    const { modal, setModal } = useModal("modal-data-demand-maps-filter-mobile");
...
export default FilterMapsMobileModal;
