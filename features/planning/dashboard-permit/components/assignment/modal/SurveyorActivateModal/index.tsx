import { SurveyorAssignment, activateAssignmentPermit } from "@api/survey-demand/mysiista";
        ...
        <>
            ...
            >
                ...
                <Button
                    ...
                    onClick={() => {
                        submit.fetch(activateAssignmentPermit({ assignmentId: data.id, status: status, type: isActive ? "deactivate-permits" : "activate-permits" }), {
                            onResolve: () => {
                                closeModal();
                                refresh();
                            },
