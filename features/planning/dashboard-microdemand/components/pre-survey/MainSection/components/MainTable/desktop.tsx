...
import { getModalId, tableDataDefaultPreSurvey } from "@features/planning/dashboard-microdemand/functions/dashboard";
...
const MainTable: React.FC = () => {
    ...
    const getTableData = () => {
        return tableDataDefaultPreSurvey({ row, page, setData });
    };
