...
import { usePolygonStore } from "@features/planning/dashboard-microdemand/store/global";
...
const PolygonPicker: React.FC<{ selectedPolygon: Polygon[]; setPolygon: (polygon: Polygon[]) => void }> = ({ selectedPolygon, setPolygon }) => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col border rounded border-black-50 h-[18.75rem] mt-2">
            ...
            <PolygonModal polygons={polygonStore.data} selectedPolygons={selectedPolygon} setPolygon={setPolygon} />
        </div>
    );
};
